...
public:
    ...
    bool GetUseMultiSwapChain() const
    {
        return useMultiSwapChain_;
    }
    bool GetUseBasisEngine() const
    {
        return useBasisEngine_;
    }
    CORE_NS::IEngine::Ptr GetEngine() const
    {
        return engine_;
    }
    CORE3D_NS::IGraphicsContext::Ptr GetGraphicsContext() const
    {
        return graphicsContext_;
    }
    RENDER_NS::IRenderContext::Ptr GetRenderContext() const
    {
...
#undef TO_STRING
        ...
        constexpr BASE_NS::Uid plugins[] = {RENDER_NS::UID_RENDER_PLUGIN, CORE3D_NS::UID_3D_PLUGIN};
...
#undef TO_STRING
    ...
    static void CreateRenderContext()
    {
        ...
        renderContext_ =
            RENDER_NS::IRenderContext::Ptr(static_cast<RENDER_NS::IRenderContext*>(renderInstance.release()));
 ...
 * @tc.desc: Verify SetRenderOutput handles null output without
 * crashing
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Verify SetRenderOutput handles valid output without
 * crashing
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Verify SetRenderOutput can be called multiple times
 * without crashing
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Verify SetRenderOutput called before Initialize
 * doesn't crash
 * @tc.type: FUNC
 */
