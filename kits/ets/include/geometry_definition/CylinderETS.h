...
#ifndef GEOMETRY_DEFINITION_CYLINDER_ETS_H
#define GEOMETRY_DEFINITION_CYLINDER_ETS_H
...
class CylinderETS : public GeometryDefinition {
public:
    explicit CylinderETS(float radius, float height, uint32_t segmentCount);
    ~CylinderETS() override = default;
...
#endif  // GEOMETRY_DEFINITION_CYLINDER_ETS_H