...
void InitSceneAddonApi(CORE_NS::IPluginRegister& (*getPluginRegister)(),
    void (*createPluginRegistry)(const struct CORE_NS::PlatformCreateInfo& platformCreateInfo))
{
    CORE_NS::GetPluginRegister = getPluginRegister;
    CORE_NS::CreatePluginRegistry = createPluginRegistry;
}
