...
#ifndef OHOS_RENDER_3D_VEC2_PROXY_H
#define OHOS_RENDER_3D_VEC2_PROXY_H
...
class Vec2Proxy : public PropertyProxy {
...
public:
    ...
    ~Vec2Proxy() override;
    bool SetValue(NapiApi::Object v) override;
...
#endif // OHOS_RENDER_3D_VEC2_PROXY_H
