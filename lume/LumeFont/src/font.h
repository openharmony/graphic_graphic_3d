...
public:
    ...
    void SetMethod(FontMethod) override;
    /** Get current font method */
    FontMethod GetMethod() override;
    ...
    BASE_NS::vector<GlyphContour> GetGlyphContours(uint32_t glyphIndex) override;
...
private:
    ...
    FontMethod fontMethod_ { FontMethod::RASTER };
