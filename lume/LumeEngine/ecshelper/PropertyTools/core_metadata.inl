...
#define DECL_NAMED_PROPERTY2(prop_name, name, displayname, flags) DECL_NAMED_PROPERTY(COMPTYPE, prop_name, name, displayname, flags)
#define DECL_PROPERTY2(structName, name, displayname, flags) DECL_NAMED_PROPERTY(structName, name, name, displayname, flags)
