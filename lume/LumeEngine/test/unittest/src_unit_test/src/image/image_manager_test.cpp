...
UNIT_TEST(SRC_ImageManagerTest, loadImages, testing::ext::TestSize.Level1)
{
    ...
    testImages.emplace_back(TestImage{"test://image/canine_284x323.jpg",
        284,
        323,
        1,
        1,
        ...
        TYPE_2D,
        VTYPE_2D,
        lrgb});  // NOTE: We are Loading RGB as RGBA.
    testImages.emplace_back(TestImage{"test://image/canine_512x512.jpg",
        512,
        512,
        1,
        1,
        ...
        VTYPE_2D,
        lrgb});  // NOTE: We are Loading RGB as RGBA.
    testImages.emplace_back(TestImage{"test://image/canine_512x512.png",
        512,
        512,
        1,
        1,
        ...
        VTYPE_2D,
        lrgb});  // NOTE: We are Loading RGB as RGBA.
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA.png",
        8,
        1,
        1,
        1,
    ...
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA.png",
        ...
        srgb,
        std::vector<TestImageData>({{0, (void*)pixelDataRGBA8}})});
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA.ktx",
        8,
        1,
        1,
        1,
        ...
        lrgb,
        std::vector<TestImageData>({{0, (void*)pixelDataRGBA8}})});
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA16.png",
        8,
        1,
        1,
        1,
    ...
    testImages.emplace_back(TestImage{"test://image/gradient_256x1_R8.png",
        256,
        1,
        1,
        1,
        ...
        VTYPE_2D,
        lrgb,
        std::vector<TestImageData>({{0, (void*)gradientPixelDataR8}})});
    testImages.emplace_back(TestImage{"test://image/gradient_256x256_R16.png",
        256,
        256,
        1,
        1,
    ...
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA.png",
        ...
        VTYPE_2D,
        premult,
        std::vector<TestImageData>({{0, (void*)pixelDataRGBA8Premultiplied}})});
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA16.png",
        8,
        1,
        1,
        ...
        VTYPE_2D,
        premult,
        std::vector<TestImageData>({{0, (void*)pixelDataRGBA16Premultiplied}})});
    ...
    testImages.emplace_back(TestImage{"test://image/test_image_8x1_RGBA.png",
        ...
        VTYPE_2D,
        premultS,
        std::vector<TestImageData>({{0, (void*)pixelDataSRGBA8Premultiplied}})});

    // Cubemaps.
    testImages.emplace_back(TestImage{"test://image/cubemap_yokohama_RGBA8.ktx",
        512,
        512,
        1,
        1,
        ...
        VTYPE_CUBE,
        lrgb});
    testImages.emplace_back(TestImage{"test://image/cubemap_yokohama_RGBA8_mipmap.ktx",
        512,
        512,
        1,
        1,
        ...
        VTYPE_CUBE,
        lrgb});
    testImages.emplace_back(TestImage{"test://image/envmaps/cubemap_yokohama_irradiance_RGBA8.ktx",
        256,
        256,
        1,
        1,
        ...
        6,
        cube,
        Format::BASE_FORMAT_R8G8B8A8_UINT,
        TYPE_2D,
        VTYPE_CUBE,
        lrgb});
    testImages.emplace_back(TestImage{"test://image/envmaps/cubemap_yokohama_irradiance_RGBA16F.ktx",
        256,
        256,
        1,
        1,
        ...
        VTYPE_CUBE,
        lrgb});
    testImages.emplace_back(TestImage{"test://image/envmaps/cubemap_yokohama_radiance_RGBA8.ktx",
        256,
        256,
        1,
        1,
        ...
        VTYPE_CUBE,
        lrgb});
    testImages.emplace_back(TestImage{"test://image/envmaps/cubemap_yokohama_radiance_RGBA16F.ktx",
        256,
        256,
        1,
        1,
    ...
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_R8.png",
        128,
        128,
        1,
        1,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RG8.png",
        128,
        128,
        1,
        1,
        ...
        TYPE_2D,
        VTYPE_2D,
        0});  // NOTE: We are Loading gray + alpha as RGBA.
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RGB8.png",
        128,
        128,
        1,
        1,
        ...
        TYPE_2D,
        VTYPE_2D,
        0});  // NOTE: We are Loading RGB as RGBA.
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RGBA8.png",
        128,
        128,
        1,
        1,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_R16.png",
        128,
        128,
        1,
        1,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RG16.png",
        128,
        128,
        1,
        1,
        ...
        VTYPE_2D,
        0});  // NOTE: We are Loading gray + alpha as RGBA.
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RGB16.png",
        128,
        128,
        1,
        1,
        ...
        VTYPE_2D,
        0});  // NOTE: We are Loading RGB as RGBA.
    testImages.emplace_back(TestImage{"test://image/png/canine_128x128_RGBA16.png",
        128,
        128,
        1,
        1,
    ...
    // BCx
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGB8_BC1_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC1_RGB_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGBA8_BC2_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC2_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGBA8_BC3_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC3_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    ...
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGB8_BC1_UB_lRGB.ktx",
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC1_RGB_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        srgb});
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGBA8_BC2_UB_lRGB.ktx",
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC2_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        srgb});
    testImages.emplace_back(TestImage{"test://image/bc/canine_128x128_RGBA8_BC3_UB_lRGB.ktx",
        ...
        1,
        compressed,
        Format::BASE_FORMAT_BC3_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        srgb});

    // EAC / ETC
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGB8_ETC1_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});

    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGB8_ETC2_RGB_UB_sRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGBA8_ETC2_RGBA_UB_sRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGBA8_ETC2_RGB_A1_UB_sRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});

    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGB8_ETC2_RGB_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGBA8_ETC2_RGBA_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RGBA8_ETC2_RGB_A1_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});

    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_R8_EAC_R11_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_EAC_R11_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_R8_EAC_R11_SB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_EAC_R11_SNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RG8_EAC_RG11_UB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_EAC_R11G11_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/etc/canine_128x128_RG8_EAC_RG11_SB_lRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_EAC_R11G11_SNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    ...
    // ASTC
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_4x4_UB_sRGB.ktx",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_4x4_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_5x4_UB_sRGB.ktx",
        128,
        128,
        1,
        5,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_5x4_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_5x5_UB_sRGB.ktx",
        128,
        128,
        1,
        5,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_5x5_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_6x5_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_6x5_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_6x6_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_8x5_UB_sRGB.ktx",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x5_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_8x6_UB_sRGB.ktx",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x6_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_10x5_UB_sRGB.ktx",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x5_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_10x6_UB_sRGB.ktx",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x6_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_8x8_UB_sRGB.ktx",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x8_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_10x8_UB_sRGB.ktx",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x8_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_10x10_UB_sRGB.ktx",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x10_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_12x10_UB_sRGB.ktx",
        128,
        128,
        1,
        12,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_12x10_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_12x12_UB_sRGB.ktx",
        128,
        128,
        1,
        12,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_12x12_SRGB_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});

    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_R8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RG8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGB8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_R16_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RG16_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGB16_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA16_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
    ...
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_ASTC_6x6_UB_lRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_6x6_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA16_ASTC_6x6_UB_lRGB.ktx",
        128,
        128,
        1,
        6,
    ...
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_nomipmap_ASTC_6x6.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_RGBA8_pad8_ASTC_6x6.ktx",
        128,
        128,
        1,
        6,
    ...
    // .astc ASTC
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_4x4.astc",
        128,
        128,
        1,
        4,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_4x4_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_5x4.astc",
        128,
        128,
        1,
        5,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_5x4_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_5x5.astc",
        128,
        128,
        1,
        5,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_5x5_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_6x5.astc",
        128,
        128,
        1,
        6,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_6x5_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_6x6.astc",
        128,
        128,
        1,
        6,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_8x5.astc",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x5_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_8x6.astc",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x6_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_8x8.astc",
        128,
        128,
        1,
        8,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_8x8_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_10x5.astc",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x5_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_10x6.astc",
        128,
        128,
        1,
        10,
        ...
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_10x8.astc",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x8_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_10x10.astc",
        128,
        128,
        1,
        10,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_10x10_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_12x10.astc",
        128,
        128,
        1,
        12,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_12x10_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/astc/canine_128x128_ASTC_12x12.astc",
        128,
        128,
        1,
        12,
        ...
        1,
        compressed,
        Format::BASE_FORMAT_ASTC_12x12_UNORM_BLOCK,
        TYPE_2D,
        VTYPE_2D,
        0});
    ...
    // Texture arrays
    testImages.emplace_back(TestImage{"test://image/arrays/canine_128x128_arrayx2_R8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_ARRAY_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/arrays/canine_128x128_arrayx3_R8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
        ...
        VTYPE_ARRAY_2D,
        0});
    testImages.emplace_back(TestImage{"test://image/arrays/canine_128x128_arrayx3mips_R8_ASTC_6x6_UB_sRGB.ktx",
        128,
        128,
        1,
        6,
    ...
    testImages.emplace_back(
        TestImage{"test://image/ktx-test/ktx/valid/composition/array_2_elements_cubemap_6_faces.ktx",
            64,
            64,
            1,
            1,
            ...
            12,
            cube,
            Format::BASE_FORMAT_R8G8B8_UNORM,
            TYPE_2D,
            VTYPE_ARRAY_CUBE,
            0});
