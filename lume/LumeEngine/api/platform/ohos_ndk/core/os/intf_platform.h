...
public:
    ...
    /** Register RAW filesystem for file manager to use
     * @param fileManager File manager instance to register to
     * @param protocol Protocol to register, usually "raw"
     */
    virtual void RegisterRawFilesystem(IFileManager& fileManager, BASE_NS::string_view protocol) const = 0;
