                    ...
                    if (property.info) {
                        switch (property.info->type) {
                            ...
                            case PropertyType::VEC2_T:
                                ReadVecPropertyValue<Vec2, 2>(*propertiesIt, property, error);
                                break;
                            case PropertyType::VEC3_T:
                                ReadVecPropertyValue<Vec3, 3>(*propertiesIt, property, error);
                                break;
                            case PropertyType::VEC4_T:
                                ReadVecPropertyValue<Vec4, 4>(*propertiesIt, property, error);
                                break;
                            case PropertyType::QUAT_T:
                                ReadVecPropertyValue<Quat, 4>(*propertiesIt, property, error);
                                break;
