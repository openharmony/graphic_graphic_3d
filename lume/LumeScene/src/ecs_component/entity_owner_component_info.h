...
constexpr CORE_NS::ComponentManagerTypeInfo ENTITY_OWNER_COMPONENT_TYPE_INFO{{CORE_NS::ComponentManagerTypeInfo::UID},
    IEntityOwnerComponentManager::UID,
    CORE_NS::GetName<IEntityOwnerComponentManager>().data(),
    IEntityOwnerComponentManagerInstance,
