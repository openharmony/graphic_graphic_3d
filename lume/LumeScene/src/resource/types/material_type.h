...
#ifndef META_SRC_RESOURCE_TYPES_MATERIAL_TYPE_H
#define META_SRC_RESOURCE_TYPES_MATERIAL_TYPE_H
...
class MaterialResourceType : public META_NS::IntroduceInterfaces<META_NS::BaseObject, CORE_NS::IResourceType> {
