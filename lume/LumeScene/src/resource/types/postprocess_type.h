...
#ifndef META_SRC_RESOURCE_TYPES_POSTPROCESS_TYPE_H
#define META_SRC_RESOURCE_TYPES_POSTPROCESS_TYPE_H
...
class PostProcessResourceType : public META_NS::IntroduceInterfaces<META_NS::BaseObject, CORE_NS::IResourceType> {
