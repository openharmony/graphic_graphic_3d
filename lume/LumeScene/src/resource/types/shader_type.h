...
#ifndef META_SRC_RESOURCE_TYPES_SHADER_TYPE_H
#define META_SRC_RESOURCE_TYPES_SHADER_TYPE_H
...
class ShaderResourceType : public META_NS::IntroduceInterfaces<META_NS::BaseObject, CORE_NS::IResourceType> {
