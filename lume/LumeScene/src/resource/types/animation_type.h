...
#ifndef SCENE_SRC_RESOURCE_TYPES_ANIMATION_TYPE_H
#define SCENE_SRC_RESOURCE_TYPES_ANIMATION_TYPE_H

#include "resource_type_base.h"

SCENE_BEGIN_NAMESPACE()

class AnimationResourceType : public META_NS::IntroduceInterfaces<ResourceTypeBase> {
    META_OBJECT(AnimationResourceType, ClassId::AnimationResource, IntroduceInterfaces)
public:
    AnimationResourceType() : Super(ClassId::AnimationResource) {}
