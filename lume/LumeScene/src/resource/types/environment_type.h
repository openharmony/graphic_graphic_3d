...
#ifndef META_SRC_RESOURCE_TYPES_ENVIRONMENT_TYPE_H
#define META_SRC_RESOURCE_TYPES_ENVIRONMENT_TYPE_H
...
class EnvironmentResourceType : public META_NS::IntroduceInterfaces<META_NS::BaseObject, CORE_NS::IResourceType> {
