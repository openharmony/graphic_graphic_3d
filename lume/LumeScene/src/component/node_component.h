...
public:
    ...
    META_PROPERTY(uint32_t, NodeFlags)
};
...
public:
    ...
    SCENE_STATIC_PROPERTY_DATA(IInternalNode, uint32_t, NodeFlags, "NodeComponent.flags")
    META_END_STATIC_DATA()

    META_IMPLEMENT_PROPERTY(bool, Enabled)
    META_IMPLEMENT_PROPERTY(uint32_t, NodeFlags)
