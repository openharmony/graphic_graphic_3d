...
CORE_NS::Entity LightNode::CreateEntity(const IInternalScene::Ptr& scene)
{
    ...
    auto& context = scene->GetEcsContext();
    auto entity = sceneUtil.CreateLight(
        *context.GetNativeEcs(), lc, BASE_NS::Math::Vec3(0.0f, 0.0f, 0.0f), BASE_NS::Math::Quat(0.f, 0.f, 0.f, 1.f));
