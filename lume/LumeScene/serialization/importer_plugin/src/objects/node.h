...
#ifndef SCENE_IMP_SRC_OBJECTS_NODE_H
#define SCENE_IMP_SRC_OBJECTS_NODE_H

#include "../import_context.h"

SCENE_IMP_BEGIN_NAMESPACE()

class ImportNodeBase : public ImportBase {
public:
...
class AbstractImportNode : public ImportBase {
public:
    ImportResult Import(ImportContext& context) override;
};

class ImportNode : public ImportNodeBase {
public:
    ImportResult Import(ImportContext& context) override;
