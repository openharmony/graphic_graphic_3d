...
DEFINE_PROPERTY(BASE_NS::string, origin, "Origin", 0, )
END_COMPONENT_EXT(IResourceComponentManager, ResourceComponent, "8356ec65-f43f-4dc6-82f5-d65a51d19c11",
                  using IComponentManager::GetEntity;
                  /**
                   * @brief Get Entity from the resource id
                   */
                  virtual CORE_NS::Entity GetEntity(const CORE_NS::ResourceId& rid) const = 0;
                  /**
                   * @brief Get Entities from the resource ids
                   */
                  virtual BASE_NS::vector<CORE_NS::Entity> GetEntities(
                      const BASE_NS::array_view<const CORE_NS::MatchingResourceId>) const = 0;
                  virtual BASE_NS::vector<CORE_NS::Entity> GetEntities(
                      const BASE_NS::array_view<const CORE_NS::ResourceId>) const = 0;
                  /**
