...
#ifndef SCENE_EXT_ECS_LAZY_PROPERTY_FWD_H
#define SCENE_EXT_ECS_LAZY_PROPERTY_FWD_H
...
protected:
    ...
    {
        return object_->AttachEngineProperty(p, path).GetResult();
    }
