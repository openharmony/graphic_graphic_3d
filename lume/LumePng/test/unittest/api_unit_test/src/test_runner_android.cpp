...
void AndroidApp::SetGtestEnv()
{
    if (m_state != nullptr) {
        ...
        m_testData.gtestArgs.emplace_back(new char[20]{"PngAPITestRunner"});
        ...
        if (m_arguments) {
            ...
            m_testData.gtestArgs.emplace_back(strdup("PngAPITestRunner"));
...
extern "C" JNIEXPORT jint JNICALL Java_com_huawei_png_1api_1test_1runner_test_NativeTestRunner_onSurfaceCreatedNative(
...
extern "C" JNIEXPORT jint JNICALL Java_com_huawei_png_1src_1test_1runner_test_NativeTestRunner_onSurfaceCreatedNative(
    JNIEnv* env, jobject thiz, jobject context, jobject surface, jstring outputFile, jobjectArray arguments)
{
    // Set up AndroidApp
    BASE_NS::unique_ptr<Test::TestApp> app =
