...
#include "render/render_node_dotfield_render.h"
...
constexpr RenderDataStoreTypeInfo RenderDataDefaultDotfieldTypeInfo = {
    ...
    RenderDataStoreDefaultDotfield::Destroy,
};
...
constexpr RenderNodeTypeInfo RenderNodeDotfieldRenderTypeInfo = {
    RenderNodeTypeInfo::UID,
    RenderNodeDotfieldRender::UID,
    RenderNodeDotfieldRender::TYPE_NAME,
    RenderNodeDotfieldRender::Create,
    RenderNodeDotfieldRender::Destroy,
    RenderNodeDotfieldRender::BACKEND_FLAGS,
    RenderNodeDotfieldRender::CLASS_TYPE,
};

constexpr RenderNodeTypeInfo gRenderNodes[] = {
    RenderNodeDotfieldSimulationTypeInfo,
    RenderNodeDotfieldRenderTypeInfo,
};
...
array_view<const RenderDataStoreTypeInfo> GetRenderDataStores()
{
    return gRenderDataStores;
}

array_view<const RenderNodeTypeInfo> GetRenderNodes()
{
    return gRenderNodes;
}

array_view<const ComponentManagerTypeInfo> GetComponentManagers()
{
    return gComponentManagers;
}

array_view<const SystemTypeInfo> GetSystems()
{
    return gSystems;
}
...
PluginToken Initialize(IRenderContext& context)
{
    ...
    renderDataStoreManager.Create(IRenderDataStoreDefaultDotfield::UID, "RenderDataStoreDefaultDotfield");

    {
        IRenderDataStorePod* rsp =
            static_cast<IRenderDataStorePod*>(renderDataStoreManager.Create(IRenderDataStorePod::UID, "DotfieldPodStore"));
        if (rsp) {
            struct {
