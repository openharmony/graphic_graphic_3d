...
{
    uint8_t data[16u]{static_cast<uint8_t>((hash >> 56) & 0xFF),
        static_cast<uint8_t>((hash >> 48) & 0xFF),
        static_cast<uint8_t>((hash >> 40) & 0xFF),
        static_cast<uint8_t>((hash >> 32) & 0xFF),
