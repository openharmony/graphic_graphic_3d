 ...
 * Description: Object registry interface.
...
public:
    ...
    virtual IObject::Ptr DefaultResolveObject(const IObjectInstance::Ptr& base, const RefUri& uri) const = 0;
    virtual BASE_NS::shared_ptr<IMetadata> ConstructObjectDataContainer() = 0;
};
