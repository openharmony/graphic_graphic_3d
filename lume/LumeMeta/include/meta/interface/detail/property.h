...
public:
    ...
    using ConstTypelessPropertyInterface::GetProperty;
    PropertyType GetProperty()
    {
        return p_;
    }

    using ConstTypelessPropertyInterface::GetStackProperty;
...
public:
    explicit PropertyLock(Property* p) : PropertyBaseType<Property>(p)
    {
        if (auto i = interface_cast<ILockable>(this->GetProperty())) {
            i->Lock();
        }
