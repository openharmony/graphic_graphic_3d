 ...
 * Description: Definition of IAttachment interface for attachable objects.
...
META_REGISTER_INTERFACE(IAttachable, "99570418-e6b0-4221-bb7e-e86a77a17cfb")
META_REGISTER_INTERFACE(IAttachment, "1f661207-4478-4fbb-ac1b-8ee73365d2d8")

class IAttachable : public CORE_NS::IInterface {
    META_INTERFACE(CORE_NS::IInterface, IAttachable)
public:
    /**
 ...
 */
class IAttachment : public IAttachable {
    META_INTERFACE(IAttachable, IAttachment)
public:
    /**
...
META_INTERFACE_TYPE(META_NS::IAttachable)
