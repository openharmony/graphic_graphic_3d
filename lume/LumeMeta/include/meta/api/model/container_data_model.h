...
public:
    ...
    {
        META_API_CALL_INTERFACE(Container, Add(BASE_NS::move(record)));
        return *this;
    }
    ...
    {
        META_API_CALL_INTERFACE(Container, Remove(index));
        return *this;
    }
    ...
    {
        META_API_CALL_INTERFACE(Container, Insert(index, BASE_NS::move(record)));
        return *this;
    }
};
