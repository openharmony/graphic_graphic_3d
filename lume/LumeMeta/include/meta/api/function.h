...
public:
    ...
    {
        if (context_) {
            return GetValue<ICallContext::Ptr>(*context_());
        }
        return nullptr;
    }
    ...
    DefaultFunction(BASE_NS::string n, BASE_NS::shared_ptr<Interface> obj, Func f, Internal::MetaValue* context)
...
protected:
    ...
    BASE_NS::weak_ptr<Interface> obj_;
    Func func_;
    Internal::MetaValue* const context_;
};
    ...
    BASE_NS::string_view name, BASE_NS::shared_ptr<Interface> obj, Func func, Internal::MetaValue* context)
{
    auto l = [func](auto obj, const ICallContext::Ptr& context) {
        if (auto o = obj.lock()) {
            CallFunction(context, o.get(), func);
        }
    };
    return IFunction::Ptr(
        new DefaultFunction<Interface, decltype(l)>(BASE_NS::string(name), obj, BASE_NS::move(l), context));
}
