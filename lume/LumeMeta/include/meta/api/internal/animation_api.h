...
public:
    ...
    {
        META_API_CALL_INTERFACE(Animation, SetParent(parent));
    ...
    {
        META_API_CALL_INTERFACE(Animation, Step(clock));
    }
    /**
    ...
    void Reset()
    {
        META_API_CALL_INTERFACE(Animation, Stop());
    }

    Event<IOnChanged> OnStarted()
    {
        return META_API_CALL_INTERFACE(Animation, OnStarted());
    }

    Event<IOnChanged> OnFinished()
    {
        return META_API_CALL_INTERFACE(Animation, OnFinished());
    }
...
public:
    ...
    void Pause()
    {
        META_API_CALL_INTERFACE(StartableAnimation, Pause());
    }
    /**
    ...
    void Restart()
    {
        META_API_CALL_INTERFACE(StartableAnimation, Restart());
    }
    /**
    ...
    {
        META_API_CALL_INTERFACE(StartableAnimation, Seek(position));
    }
    /**
    ...
    void Start()
    {
        META_API_CALL_INTERFACE(StartableAnimation, Start());
    }
    /**
    ...
    void Stop()
    {
        META_API_CALL_INTERFACE(StartableAnimation, Stop());
    }
};
...
public:
    ...
    {
        META_API_CALL_INTERFACE(Container, Add(child));
        return static_cast<FinalClassType&>(*this);
    }

    BASE_NS::vector<META_NS::IAnimation::Ptr> GetAnimations()
    {
        return META_API_CALL_INTERFACE(StaggeredAnimation, GetAnimations());
    }
};
