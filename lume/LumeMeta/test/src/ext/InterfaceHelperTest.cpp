...
class InterfaceHelperTest : public testing::Test {
public:
...
HWTEST_F(InterfaceHelperTest, IntroduceInterfaces, TestSize.Level1)
{
...
HWTEST_F(InterfaceHelperTest, GetInterfaces, TestSize.Level1)
{
...
HWTEST_F(InterfaceHelperTest, ILifecycleSupport, TestSize.Level1)
{
...
HWTEST_F(InterfaceHelperTest, EmbeddedIntroduceInterfacesSupport, TestSize.Level1)
{
...
HWTEST_F(InterfaceHelperTest, EmbeddedIntroduceInterfacesSupportGetInterface, TestSize.Level1)
{
    using CORE_NS::IInterface;
    TopClass c;
    EXPECT_TRUE(c.GetInterface(CORE_NS::IInterface::UID) == static_cast<IInterface*>(c.Cast<BaseA>()));
