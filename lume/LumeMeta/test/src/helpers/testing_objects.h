...
META_INTERFACE_TYPE_IMP(META_NS::ITestString, "META_NS::Test::ITestString")
META_INTERFACE_TYPE_IMP(META_NS::ITestPtrValue, "META_NS::Test::ITestPtrValue")
META_INTERFACE_TYPE_IMP(META_NS::ITestType, "META_NS::Test::ITestType")
META_INTERFACE_TYPE_IMP(META_NS::IEmbeddedTestType, "META_NS::Test::IEmbeddedTestType")
META_TYPE_IMPL(META_NS::MyTestType, "META_NS::Test::MyTestType")
META_TYPE_IMPL(META_NS::MyComparableTestType, "META_NS::Test::MyComparableTestType")
META_TYPE_IMPL(META_NS::TestEnum, "META_NS::Test::TestEnum")
