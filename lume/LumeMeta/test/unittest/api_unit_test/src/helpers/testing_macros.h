...
#ifndef META_TEST_TESTING_MACROS_HEADER
#define META_TEST_TESTING_MACROS_HEADER
...
#define META_WAIT_TIMED(millis) std::this_thread::sleep_for(std::chrono::milliseconds(millis));
