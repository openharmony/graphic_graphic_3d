...
class TestAttachment : public IntroduceInterfaces<META_NS::AttachmentFwd, META_NS::UTest::ITestAttachment> {
...
public:
    ...
    META_STATIC_PROPERTY_DATA(META_NS::UTest::ITestAttachment, BASE_NS::string, Name)
    META_STATIC_EVENT_DATA(META_NS::UTest::ITestStartable, META_NS::IOnChanged, OnStarted)
    META_STATIC_EVENT_DATA(META_NS::UTest::ITestStartable, META_NS::IOnChanged, OnStopped)
    META_STATIC_EVENT_DATA(META_NS::UTest::ITestStartable, META_NS::IOnChanged, OnTicked)
    META_END_STATIC_DATA()
...
class TestContainerPreTransaction : public META_NS::IntroduceInterfaces<TestContainerFwd, IContainerPreTransaction> {
    META_OBJECT(
        TestContainerPreTransaction, ClassId::TestContainerPreTransaction, TestContainerFwd, ClassId::ObjectContainer)
public:
...
void RegisterTestTypes()
{
    ...
    registry.RegisterObjectType(TestContainerPreTransaction::GetFactory());
...
void UnregisterTestTypes()
{
    ...
    registry.UnregisterObjectType(TestContainerPreTransaction::GetFactory());
