...
class API_AnimationModifierTestBase;

namespace {
struct TestDefinition {
    std::string name;
    std::function<IAnimation::Ptr(API_AnimationModifierTestBase&)> constructor;
    std::function<IAnimation::Ptr(API_AnimationModifierTestBase& test, IAnimation::Ptr)> transform = [](auto&, auto p) {
        return p;
    };
};
 ...
 * @tc.desc: Tests for Reverse Implicit Animation. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_F(API_AnimationModifierTestBase, ReverseImplicitAnimation, testing::ext::TestSize.Level1)
{
...
class API_LoopAnimationModifierTest : public API_AnimationModifierTestBase {
public:
    int GetLoopCount()
    {
...
class API_SpeedAnimationModifierTest : public API_AnimationModifierTestBase {
public:
...
class API_ReverseAnimationModifierTest : public API_AnimationModifierTestBase {
public:
...
std::string BuildTestName(const testing::TestParamInfo<API_LoopAnimationModifierTest::ParamType>& info)
{
    return std::get<0>(info.param).name + "Animation" + std::to_string(info.index);
}

IAnimation::Ptr CreateKeyFrameAnimation(API_AnimationModifierTestBase& test)
{
...
IAnimation::Ptr CreatePropertyAnimation(API_AnimationModifierTestBase& test)
{
...
IAnimation::Ptr CreateParallelAnimation(API_AnimationModifierTestBase& test)
{
...
IAnimation::Ptr CreateSequentialAnimation(API_AnimationModifierTestBase& test)
{
    auto anim1 = CreateKeyFrameAnimation(test);
    auto anim2 = CreateTrackAnimation(test);
...
IAnimation::Ptr Serialize(API_AnimationModifierTestBase& test, IAnimation::Ptr anim)
{
    TestSerialiser ser;
 ...
 * @tc.desc: Tests for Reversed Animation Is Played Backward. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_ReverseAnimationModifierTest, ReversedAnimationIsPlayedBackward, testing::ext::TestSize.Level1)
{
...
{
    IObject::Ptr attachment;
    META_NS::Animation animation(anim);
    if (auto mod = animation.GetModifiers(); !mod.empty()) {
        attachment = interface_pointer_cast<IObject>(mod.front());
    }
    return attachment;
}
 ...
 * @tc.desc: Tests for Loop Count Modifies Duration. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_LoopAnimationModifierTest, LoopCountModifiesDuration, testing::ext::TestSize.Level1)
{
    auto anim = GetAnimation();
 ...
 * @tc.desc: Tests for Animation Is Looping Regardless Of Speed Modificator. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(
    API_LoopAnimationModifierTest, AnimationIsLoopingRegardlessOfSpeedModificator, testing::ext::TestSize.Level1)
{
 ...
 * @tc.desc: Tests for Animation Islooping. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_LoopAnimationModifierTest, AnimationIslooping, testing::ext::TestSize.Level1)
{
    auto anim = GetAnimation();
    int loopCount = GetLoopCount();
    auto originalDuration = GetValue(anim->TotalDuration());
 ...
 * @tc.desc: Tests for Duplicate Properties. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_LoopAnimationModifierTest, DuplicateProperties, testing::ext::TestSize.Level1)
{
 ...
 * @tc.desc: Tests for Speed Factor Modifies Duration. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_SpeedAnimationModifierTest, SpeedFactorModifiesDuration, testing::ext::TestSize.Level1)
{
    auto anim = GetAnimation();
 ...
 * @tc.desc: Tests for Speed Factor Affects Playback. [AUTO-GENERATED]
 * @tc.type: FUNC
 */
UNIT_TEST_P(API_SpeedAnimationModifierTest, SpeedFactorAffectsPlayback, testing::ext::TestSize.Level1)
{
    auto anim = GetAnimation();
