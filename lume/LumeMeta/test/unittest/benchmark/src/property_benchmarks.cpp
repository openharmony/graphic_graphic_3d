...
// IObject
BENCHMARK_CAPTURE(GettingPropertyValue, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(SettingPropertyValue, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(SettingPropertyValueWithDependency, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(SettingPropertyValueWithDependencyChain, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(BindingProperty, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(BindingPropertyChain, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(EvaluatingProperty, IObject, CreateInstance(ClassId::Object));
BENCHMARK_CAPTURE(EvaluatingPropertyChain, IObject, CreateInstance(ClassId::Object));
...
/*
BENCHMARK_CAPTURE(SettingPropertyValueWithValidator, RefusedPropertyWidget, IObject::Ptr(),
    CreateShared<NotNullValidator<IObject::Ptr>>());

BENCHMARK_CAPTURE(
    SettingPropertyValueWithValidator, ValidatedPropertyInteger, 10, CreateShared<ClampValidator<int>>(0, 10));
BENCHMARK_CAPTURE(
    SettingPropertyValueWithValidator, ClampedPropertyInteger, 20, CreateShared<ClampValidator<int>>(0, 10));

BENCHMARK_CAPTURE(SettingPropertyValue, PropertyInteger, 10);

BENCHMARK_CAPTURE(
    SettingPropertyValueWithValidator, ValidatedPropertyFloat, 10.0F, CreateShared<ClampValidator<float>>(0.0F, 10.0F));
BENCHMARK_CAPTURE(
    SettingPropertyValueWithValidator, ClampedPropertyFloat, 20.0F, CreateShared<ClampValidator<float>>(0.0F, 10.0F));
*/
