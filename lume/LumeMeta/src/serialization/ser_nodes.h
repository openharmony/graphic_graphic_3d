...
class NilNode : public IntroduceInterfaces<BaseObject, INilNode> {
...
class MapNode : public IntroduceInterfaces<BaseObject, IMapNode> {
...
class ArrayNode : public IntroduceInterfaces<BaseObject, IArrayNode> {
...
class ObjectNode : public IntroduceInterfaces<BaseObject, IObjectNode> {
    META_OBJECT(ObjectNode, ClassId::ObjectNode, IntroduceInterfaces)
public:
    ObjectNode() = default;
...
class RootNode : public IntroduceInterfaces<BaseObject, IRootNode> {
