...
class InterfaceHelpersTest : public testing::Test {
public:
...
/**
 * @tc.name: InterfaceHelpersTest
 * @tc.desc: test IntroduceInterfaces function
 * @tc.type: FUNC
 * @tc.require: I7DMS1
 */
HWTEST_F(InterfaceHelpersTest, IntroduceInterfaces, TestSize.Level1)
{
...
/**
 * @tc.name: InterfaceHelpersTest
 * @tc.desc: test GetInterfaces function
 * @tc.type: FUNC
 * @tc.require: I7DMS1
 */
HWTEST_F(InterfaceHelpersTest, GetInterfaces, TestSize.Level1)
{
...
/**
 * @tc.name: InterfaceHelpersTest
 * @tc.desc: test ILifecycleSupport function
 * @tc.type: FUNC
 * @tc.require: I7DMS1
 */
HWTEST_F(InterfaceHelpersTest, ILifecycleSupport, TestSize.Level1)
{
...
/**
 * @tc.name: InterfaceHelpersTest
 * @tc.desc: test EmbeddedIntroduceInterfacesSupport function
 * @tc.type: FUNC
 * @tc.require: I7DMS1
 */
HWTEST_F(InterfaceHelpersTest, EmbeddedIntroduceInterfacesSupport, TestSize.Level1)
{
...
/**
 * @tc.name: InterfaceHelpersTest
 * @tc.desc: test EmbeddedIntroduceInterfacesSupportGetInterface function
 * @tc.type: FUNC
 * @tc.require: I7DMS1
 */
HWTEST_F(InterfaceHelpersTest, EmbeddedIntroduceInterfacesSupportGetInterface, TestSize.Level1)
{
    using CORE_NS::IInterface;
    TopClass c;
    EXPECT_TRUE(c.GetInterface(CORE_NS::IInterface::UID) == static_cast<IInterface*>(c.Cast<BaseA>()));
