...
class InstantiatingObjectProvider
    : public Internal::ConcreteBaseFwd<InstantiatingObjectProvider, ClassId::InstantiatingObjectProvider,
          ObjectProviderBase, IInstantiatingObjectProvider> {
public:
