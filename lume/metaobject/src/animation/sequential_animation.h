...
class SequentialAnimation final : public BaseAnimationContainerFwd<SequentialAnimation,
                                      META_NS::ClassId::SequentialAnimation, ISequentialAnimation> {
    using Super =
        BaseAnimationContainerFwd<SequentialAnimation, META_NS::ClassId::SequentialAnimation, ISequentialAnimation>;
