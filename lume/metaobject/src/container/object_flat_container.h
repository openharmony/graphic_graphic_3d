...
class ObjectFlatContainer
    : public Internal::ObjectFwd<ObjectFlatContainer, ClassId::ObjectFlatContainer, FlatContainer> {
    using Super = Internal::ObjectFwd<ObjectFlatContainer, ClassId::ObjectFlatContainer, FlatContainer>;
