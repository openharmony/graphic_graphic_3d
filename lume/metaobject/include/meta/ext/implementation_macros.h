...
#define META_IMPLEMENT_ARRAY_PROPERTY(...) \
    META_EXPAND(META_GET_PROPERTY(META_DEFINE_PROPERTY, Array, META_NS::InterfaceInfo {}, __VA_ARGS__))
#define META_IMPLEMENT_READONLY_ARRAY_PROPERTY(...) \
    META_EXPAND(META_GET_PROPERTY(META_DEFINE_READONLY_PROPERTY, Array, META_NS::InterfaceInfo {}, __VA_ARGS__))
