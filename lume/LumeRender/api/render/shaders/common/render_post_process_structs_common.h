...
#define POST_PROCESS_SPECIALIZATION_UPSCALE_BIT (1 << 5)
#define POST_PROCESS_SPECIALIZATION_WHITE_BALANCE_BIT (1 << 6)
#define POST_PROCESS_SPECIALIZATION_COLOR_ADJUSTMENTS_BIT (1 << 7)
...
#define POST_PROCESS_INDEX_WHITE_BALANCE 6
#define POST_PROCESS_INDEX_COLOR_ADJUSTMENTS 7

#define POST_PROCESS_USER_INDEX_COLOR_ADJUSTMENTS_FILTER_COLOR 0
