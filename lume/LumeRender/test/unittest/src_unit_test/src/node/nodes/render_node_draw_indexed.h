...
#ifndef RENDER_NODE_DRAW_INDEXED_H
#define RENDER_NODE_DRAW_INDEXED_H
...
class RenderNodeDrawIndexed final : public IRenderNode {
public:
    RenderNodeDrawIndexed() = default;
    ~RenderNodeDrawIndexed() override = default;
    ...
    static constexpr char const* TYPE_NAME = "RenderNodeDrawIndexed";
