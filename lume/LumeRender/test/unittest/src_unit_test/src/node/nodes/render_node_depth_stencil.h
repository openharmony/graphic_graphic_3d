...
#ifndef RENDER_NODE_DEPTH_STENCIL_H
#define RENDER_NODE_DEPTH_STENCIL_H
...
class RenderNodeDepthStencil final : public IRenderNode {
public:
    RenderNodeDepthStencil() = default;
    ~RenderNodeDepthStencil() override = default;
    ...
    static constexpr BASE_NS::Uid UID{"5e11c8c9-cfdc-4920-bcb4-68b984470b95"};
    static constexpr const char* TYPE_NAME = "RenderNodeDepthStencil";
...
#endif  // RENDER_NODE_DEPTH_STENCIL_H