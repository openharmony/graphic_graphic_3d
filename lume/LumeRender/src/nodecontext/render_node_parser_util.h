...
#ifndef RENDER_NODECONTEXT_RENDER_NODE_PARSER_UTIL_H
#define RENDER_NODECONTEXT_RENDER_NODE_PARSER_UTIL_H
...
#endif // RENDER_NODECONTEXT_RENDER_NODE_PARSER_UTIL_H
