...
constexpr const FormatFeatures IMAGE_FORMAT_FEATURES[] = {
    ...
    {GL_COMPRESSED_SRGB_S3TC_DXT1_EXT, TF_TEX},
    {GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT, TF_TEX},
    {GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT, TF_TEX},
    {GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT, TF_TEX},
#endif
...
constexpr DeviceGLES::ImageFormat IMAGE_FORMATS_EXT_SRGB[] = {
    {BASE_FORMAT_BC1_RGB_SRGB_BLOCK,
        GL_RGB,
        GL_COMPRESSED_SRGB_S3TC_DXT1_EXT,
        GL_UNSIGNED_BYTE,
        0,
        {true, 4, 4, BLOCK_BITS_64},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_BC1_RGBA_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 4, 4, BLOCK_BITS_64},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_BC2_SRGB_BLOCK,
        GL_RGBA,
        GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT,
        GL_UNSIGNED_BYTE,
        0,
        {true, 4, 4, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_BC3_SRGB_BLOCK,
        GL_RGBA,
...
constexpr DeviceGLES::ImageFormat IMAGE_FORMATS_FALLBACK[] = {
    {BASE_FORMAT_R4G4_UNORM_PACK8,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_ZERO, GL_ONE}},
    {BASE_FORMAT_B4G4R4A4_UNORM_PACK16,
        GL_RGBA,
        GL_RGBA4,
    ...
    {BASE_FORMAT_B5G6R5_UNORM_PACK16,
        GL_RGB,
        GL_RGB565,
    ...
    {BASE_FORMAT_B5G5R5A1_UNORM_PACK16,
        GL_RGBA,
        GL_RGB5_A1,
        ...
        {false, 0, 0, 0},
        {GL_BLUE, GL_GREEN, GL_RED, GL_ALPHA}},
    {BASE_FORMAT_A1R5G5B5_UNORM_PACK16,
        GL_RGBA,
        GL_RGB5_A1,
        GL_UNSIGNED_SHORT_5_5_5_1,
        2,
    ...
    {BASE_FORMAT_R8_SRGB, GL_RED, GL_SRGB8, GL_UNSIGNED_BYTE, 1, {false, 0, 0, 0}, {GL_RED, GL_ZERO, GL_ZERO, GL_ONE}},
    {BASE_FORMAT_R8G8_SRGB,
        GL_RG,
        GL_SRGB8,
        GL_UNSIGNED_BYTE,
    ...
    {BASE_FORMAT_R16_UNORM, GL_RED, GL_R16F, GL_HALF_FLOAT, 2, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R16G16_UNORM,
        GL_RG,
        GL_RG16F,
        GL_HALF_FLOAT,
...
constexpr DeviceGLES::ImageFormat IMAGE_FORMATS[] = {
    {BASE_FORMAT_UNDEFINED, GL_NONE, GL_NONE, GL_NONE, 0, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    // These are required in GL and GLES
    {BASE_FORMAT_R8_UNORM, GL_RED, GL_R8, GL_UNSIGNED_BYTE, 1, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R8_SNORM, GL_RED, GL_R8_SNORM, GL_BYTE, 1, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    ...
    {BASE_FORMAT_R8G8B8_UNORM,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R8G8B8_SNORM, GL_RGB, GL_RGB8, GL_BYTE, 3, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    ...
    {BASE_FORMAT_R16G16B16A16_SFLOAT,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R32_SFLOAT, GL_RED, GL_R32F, GL_FLOAT, 4, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R32G32_SFLOAT, GL_RG, GL_RG32F, GL_FLOAT, 8, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R32G32B32_SFLOAT,
        GL_RGB,
        GL_RGB32F,
        GL_FLOAT,
        12,
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R32G32B32A32_SFLOAT,
        GL_RGBA,
        GL_RGBA32F,
        GL_FLOAT,
        16,
    ...
    {BASE_FORMAT_B10G11R11_UFLOAT_PACK32,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_E5B9G9R9_UFLOAT_PACK32,
        GL_RGB,
        GL_RGB9_E5,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R8_SINT, GL_RED_INTEGER, GL_R8I, GL_BYTE, 1, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R8_UINT,
        GL_RED_INTEGER,
        GL_R8UI,
        GL_UNSIGNED_BYTE,
    ...
    {BASE_FORMAT_R16_UINT,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R32_SINT, GL_RED_INTEGER, GL_R32I, GL_INT, 4, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    ...
    {BASE_FORMAT_EAC_R11_UNORM_BLOCK,
        ...
        {true, 4, 4, BLOCK_BITS_64},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_EAC_R11_SNORM_BLOCK,
        GL_RED,
    ...
    {BASE_FORMAT_EAC_R11G11_UNORM_BLOCK,
        ...
        {true, 4, 4, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_EAC_R11G11_SNORM_BLOCK,
        GL_RG,
    ...
    {BASE_FORMAT_ETC2_R8G8B8_UNORM_BLOCK,
        ...
        {true, 4, 4, BLOCK_BITS_64},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ETC2_R8G8B8_SRGB_BLOCK,
        GL_RGB,
    ...
    {BASE_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK,
        ...
        {true, 4, 4, BLOCK_BITS_64},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK,
        GL_RGBA,
    ...
    {BASE_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK,
        ...
        {true, 4, 4, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK,
        GL_RGBA,
    ...
    {BASE_FORMAT_R16G16_UNORM,
        ...
        {false, 0, 0, 0},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_R16G16_SNORM, GL_RG, GL_RG16, GL_SHORT, 4, {false, 0, 0, 0}, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    ...
    {BASE_FORMAT_ASTC_12x12_UNORM_BLOCK,
        ...
        GL_UNSIGNED_BYTE,
        0,
        {true, 12, 12, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_4x4_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 4, 4, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_5x4_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 5, 4, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_5x5_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 5, 5, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_6x5_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 6, 5, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_6x6_SRGB_BLOCK,
        GL_RGBA,
    ...
    {BASE_FORMAT_ASTC_8x5_SRGB_BLOCK,
        ...
        {true, 8, 5, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_8x6_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 8, 6, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_8x8_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 8, 8, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_10x5_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 10, 5, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_10x6_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 10, 6, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_10x8_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 10, 8, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_10x10_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 10, 10, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_12x10_SRGB_BLOCK,
        GL_RGBA,
        ...
        {true, 12, 10, BLOCK_BITS_128},
        {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}},
    {BASE_FORMAT_ASTC_12x12_SRGB_BLOCK,
        GL_RGBA,
...
DeviceGLES::DeviceGLES(RenderContext& renderContext) : Device(renderContext)
{
    ...
    if (const auto pos = std::lower_bound(extensions_.cbegin(),
            extensions_.cend(),
            EXT_BUFFER_STORAGE,
...
bool DeviceGLES::HasExtension(const string_view extension) const
{
    return std::binary_search(
        extensions_.begin(), extensions_.end(), extension, [](const string_view& element, const string_view value) {
...
FormatProperties DeviceGLES::GetFormatProperties(const Format format) const
{
    ...
    if (glFormat.internalFormat != GL_NONE) {
        if (auto pos = std::find_if(std::begin(IMAGE_FORMAT_FEATURES),
                std::end(IMAGE_FORMAT_FEATURES),
...
{
    if (initialData.size_bytes() < sizeof(CacheHeader)) {
        return;
    }
    ...
    if ((header->version != CACHE_VERSION) ||
        (header->revisionHash != Hash(string_view(vendor), string_view(renderer), string_view(version)))) {
        return;
    }
    // Use 64-bit arithmetic to prevent overflow when programs count is large.
    if ((static_cast<uint64_t>(sizeof(CacheHeader)) +
            static_cast<uint64_t>(header->programs) * sizeof(CacheHeader::Program)) > initialData.size()) {
        return;
    }
    ...
    // Validate that offsets are monotonically increasing before processing.
    bool offsetsValid = programs.empty() || (programs[0].offset < binaryData.size());
    for (size_t i = 1; i < programs.size(); ++i) {
        if ((programs[i].offset < programs[i - 1].offset) || (programs[i].offset >= binaryData.size())) {
            offsetsValid = false;
            break;
        }
    }
    ...
    for (auto i = 0U; i < programs.size(); ++i) {
        ...
        if ((i + 1) < programs.size()) {
            length = static_cast<GLsizei>(programs[i + 1].offset - program.offset);
        } else {
            length = static_cast<GLsizei>(binaryData.size() - program.offset);
        }
        ...
        if (result != GL_FALSE) {
            ...
            PLUGIN_LOG_ONCE_E("gl_shader_linking_error_" + to_string(programObj),
                "RENDER_VALIDATION: Shader linking error: %s",
                messages.c_str());
#endif
...
vector<uint8_t> DeviceGLES::GetPipelineCache() const
{
    ...
    header.version = CACHE_VERSION;
    {
        ...
        header.revisionHash = Hash(string_view(v ? v : ""), string_view(r ? r : ""), string_view(ver ? ver : ""));
    }
    ...
    CloneData(cacheData.data() + sizeof(CacheHeader),
        cacheData.size() - sizeof(CacheHeader),
        programs.data(),
...
{
    const uint32_t targetId = TextureTargetToTargetId(target);
    if ((textureUnit >= BASE_NS::countof(boundTexture_)) ||
        (targetId >= BASE_NS::countof(boundTexture_[textureUnit]))) {
#if (RENDER_VALIDATION_ENABLED == 1)
    ...
    uint32_t image, uint32_t target, uint32_t levels, uint32_t internalformat, const Math::UVec2& extent)
{
    SetActiveTextureUnit(TEMP_BIND_UNIT);
    BindTexture(TEMP_BIND_UNIT, target, image);
    glTexStorage2D(static_cast<GLenum>(target),
    ...
    const Math::UVec2& extent, bool fixedsamplelocations)
{
    SetActiveTextureUnit(TEMP_BIND_UNIT);
    BindTexture(TEMP_BIND_UNIT, target, image);
    glTexStorage2DMultisample(static_cast<GLenum>(target),
...
{
    if (const auto pos = std::lower_bound(supportedFormats_.begin(),
    ...
    if (const auto pos = std::lower_bound(std::begin(IMAGE_FORMATS_FALLBACK),
            std::end(IMAGE_FORMATS_FALLBACK),
            format,
            [](const ImageFormat& element, const Format value) { return element.coreFormat < value; });
    ...
    const LowLevelRenderPassData* renderPassData, const LowLevelPipelineLayoutData* pipelineLayoutData)
{
    ...
    auto pipeline = make_unique<GraphicsPipelineStateObjectGLES>(*this,
        gpuProgram,
        graphicsState,
        pipelineLayout,
    ...
    return unique_ptr<GraphicsPipelineStateObject>{
        pipeline->GetPlatformData().graphicsShader ? pipeline.release() : nullptr};
}
    ...
    const LowLevelPipelineLayoutData* pipelineLayoutData)
{
    ...
    return unique_ptr<ComputePipelineStateObject>{
        pipeline->GetPlatformData().computeShader ? pipeline.release() : nullptr};
}
