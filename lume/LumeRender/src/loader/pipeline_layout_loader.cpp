...
RENDER_JSON_SERIALIZE_ENUM(AdditionalDescriptorTypeImageFlagBits,
    {
        ...
        { AdditionalDescriptorTypeImageFlagBits::CORE_DESCRIPTOR_TYPE_IMAGE_DIMENSION_CUBE_BIT, "image_dimension_cube_bit" },
        { AdditionalDescriptorTypeImageFlagBits::CORE_DESCRIPTOR_TYPE_IMAGE_DIMENSION_BUFFER_BIT, "image_dimension_buffer_bit" },
        { AdditionalDescriptorTypeImageFlagBits::CORE_DESCRIPTOR_TYPE_IMAGE_DIMENSION_SUBPASS_BIT, "image_dimension_subpass_bit" },
    })
