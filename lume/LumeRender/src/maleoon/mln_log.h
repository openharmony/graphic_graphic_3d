...
#define MLN_LOG_ERR(...)                        \
    do {                                        \
        PLUGIN_LOG_E("[MLN-ERR] " __VA_ARGS__); \
    } while (0)
