...
class RenderPostProcessCombinedNode final : public CORE_NS::IInterfaceHelper<IRenderPostProcessNode> {
public:
    static constexpr auto UID = BASE_NS::Uid("e3ac92f0-ccb2-4573-9536-ac1f24d8e47b");
