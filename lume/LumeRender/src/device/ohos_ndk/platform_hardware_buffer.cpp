...
#if 0 && (OH_CURRENT_API_VERSION >= OH_API_VERSION_15)
    { NATIVEBUFFER_PIXEL_FMT_BLOB, Format::BASE_FORMAT_UNDEFINED },                // Unformatted data
    { NATIVEBUFFER_PIXEL_FMT_RGBA16_FLOAT, Format::BASE_FORMAT_R16G16B16_SFLOAT }, // RGBA16 float
#endif
};

static_assert(FORMATS[NATIVEBUFFER_PIXEL_FMT_RAW10].first == NATIVEBUFFER_PIXEL_FMT_RAW10);
