...
// create bitmasks.
static constexpr const uint8_t CHAR_MAP[] = {0U,
    0U,
    0U,
    0U,
    0U,
...
static constexpr const uint8_t STATE[] = {0U,
    12U,
    24U,
    36U,
    60U,
 ...
 *            NOTE: buf must point to a NUL-terminated string. This function relies on
 *            the null terminator to detect end-of-input. Callers using string_view must
 *            ensure the data is NUL-terminated (e.g., by copying to std::string first).
