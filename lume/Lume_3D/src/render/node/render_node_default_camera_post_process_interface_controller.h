...
#ifndef CORE3D_RENDER__NODE__RENDER_NODE_DEFAULT_CAMERA_POST_PROCESS_INTERFACE_CONTROLLER_H
#define CORE3D_RENDER__NODE__RENDER_NODE_DEFAULT_CAMERA_POST_PROCESS_INTERFACE_CONTROLLER_H
...
class RenderNodeDefaultCameraPostProcessInterfaceController final : public RENDER_NS::IRenderNode {
public:
    RenderNodeDefaultCameraPostProcessInterfaceController() = default;
    ~RenderNodeDefaultCameraPostProcessInterfaceController() override = default;
    ...
    static constexpr char const* TYPE_NAME = "RenderNodeDefaultCameraPostProcessInterfaceController";
...
private:
    ...
    RENDER_NS::IRenderNodePostProcessInterfaceUtil::Ptr rnPostProcessUtil_;
};
