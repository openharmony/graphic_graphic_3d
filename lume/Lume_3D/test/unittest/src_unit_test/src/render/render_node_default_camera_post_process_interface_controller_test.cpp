...
TestResources CreateTestResources(UTest::TestContext* testContext)
{
    ...
    // Render node graph
    {
        res.renderNodeGraph = testContext->renderContext->GetRenderNodeGraphManager().LoadAndCreate(
            ...
            "test://RenderNodeDefaultCameraPostProcessInterfaceControllerTest.rng");
    }
    // Input image
    {
 ...
 * @tc.type: FUNC
 */
UNIT_TEST(SRC_RenderNodeDefaultCameraPostProcessInterfaceControllerTest, BasicTest, testing::ext::TestSize.Level1)
{
