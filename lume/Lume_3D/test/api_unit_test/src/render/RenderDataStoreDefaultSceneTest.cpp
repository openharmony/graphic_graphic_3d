...
class RenderDataStoreDefaultSceneTest : public testing::Test {
public:
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RenderDataStoreDefaultSceneTest, CreateDestroyTest, TestSize.Level1)
{
 ...
 * @tc.desc: test GetSetScene
 * @tc.type: FUNC
 */
HWTEST_F(RenderDataStoreDefaultSceneTest, GetSetSceneTest, TestSize.Level1)
{
    auto engine = g_context.sceneInit_->GetEngineInstance().engine_;
    auto renderContext = g_context.sceneInit_->GetEngineInstance().renderContext_;
    auto graphicsContext = g_context.sceneInit_->GetEngineInstance().graphicsContext_;
