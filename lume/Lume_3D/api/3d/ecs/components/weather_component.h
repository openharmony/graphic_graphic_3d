...
/** Visible moon angular diameter in degrees **/
DEFINE_PROPERTY(float, moonSize, "Moon Size", 0U, VALUE(2.3f))
/** Visible moon opacity **/
DEFINE_PROPERTY(float, moonOpacity, "Moon Opacity", 0U, VALUE(1.0f))
/** Visible moon color tint **/
DEFINE_PROPERTY(BASE_NS::Math::Vec3, moonTint, "Moon Color", 0U, ARRAY_VALUE(0.8f, 0.8f, 0.85f))
/** Night stars intensity multiplier **/
DEFINE_PROPERTY(float, starsIntensity, "Stars Intensity", 0U, VALUE(1.0f))
/** Night sky intensity multiplier **/
DEFINE_PROPERTY(float, nightSkyIntensity, "Night Sky Intensity", 0U, VALUE(1.0f))
...
/** Visible sun angular diameter in degrees **/
DEFINE_PROPERTY(float, skySunSize, "Sun Size", 0U, VALUE(0.53f))
/** Visible sun color tint **/
DEFINE_PROPERTY(BASE_NS::Math::Vec3, skySunTint, "Sun Color", 0U, ARRAY_VALUE(1.0f, 1.0f, 1.0f))
/** Visible sun opacity **/
DEFINE_PROPERTY(float, skySunOpacity, "Sun Opacity", 0U, VALUE(1.0f))
/** World Scale **/
...
/** Rayleigh Scattering**/
DEFINE_PROPERTY(
    BASE_NS::Math::Vec3, rayleighScatteringBase, "Rayleigh Scattering Base", 0U, ARRAY_VALUE(5.802f, 13.558f, 33.1f))
/** Ozone Absorption **/
DEFINE_PROPERTY(
...
DEFINE_PROPERTY(
    BASE_NS::Math::Vec4, sunGlareColorDay, "Color of sun glare at day", 0U, ARRAY_VALUE(1.0f, 0.4444f, 0.1111f, 1.80f))
...
/** UTC offset hours from GMT [-12.0 to +14.0], e.g., +2 for EET */
DEFINE_PROPERTY(float, utc, "UTC Offset Hours", 0U, VALUE(2.0f))
/** Date: {day, month, year}, e.g., {17, 3, 2026} */
DEFINE_PROPERTY(BASE_NS::Math::UVec3, date, "Date (d,m,y)", 0U, ARRAY_VALUE(1, 1, 2026))
/** Latitude in degrees [-90 to 90], editor-provided fixed value for environment */
DEFINE_PROPERTY(float, latitude, "Latitude (degrees)", 0U, VALUE(52.0f))
/** Longitude in degrees [-180 to 180], editor-provided fixed value for environment */
DEFINE_PROPERTY(float, longitude, "Longitude (degrees)", 0U, VALUE(0.0f))
