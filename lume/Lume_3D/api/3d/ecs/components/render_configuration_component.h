...
/** Variable PCF radius for the (ECS) scene.
 */
DEFINE_PROPERTY(float, vpcfRadius, "Variable PCF Radius", 0, )

/** Variable PCF sample count for the (ECS) scene.
 */
DEFINE_PROPERTY(uint32_t, vpcfSampleCount, "Variable PCF Sample Count", 0, )
 ...
 */
DEFINE_PROPERTY(SceneShadowSmoothness, shadowSmoothness, "Shadow Smoothness", 0, VALUE(SceneShadowSmoothness::NORMAL))
 ...
 */
DEFINE_PROPERTY(BASE_NS::string, customPostSceneRenderNodeGraphFile, "Custom Post Scene Render Node Graph File", 0, )
